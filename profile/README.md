...
<h2 align="center">one:cx</h2>

With [one:cx](https://www.tracetronic.com/platform/one-cx/), we go from the big picture to the details and unite **all phases of vehicle software testing** – from planning the test scopes to summarizing the test results. At the same time, **continuous monitoring across all test phases** always provides an overview of all activities – even with several thousand test executions per day and in different test environments.
...
templates
around our platform and also around our software products [ecu.test](https://www.tracetronic.com/products/ecu-test/) and our [tracetronic AI solutions](https://tracetronic.ai).
...
Our [ecu.test Execution Plugin](https://github.com/jenkinsci/ecu-test-execution-plugin) is hosted by the Jenkins community like any other Jenkins Plugins. The repositories in this organization are only the origins.
